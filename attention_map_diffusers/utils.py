...
from .modules import *
from leffa.model import AttnProcessor2_0
...
def register_attention_hook(model, hook_function, target_name):
...
def replace_call_method_for_unet(model):
    if model.__class__.__name__ == 'UNet2DConditionModel':
        ...
        from leffa.diffusion_model.unet_gen import UNet2DConditionModel 
    ...
    for name, layer in model.named_children():
        ...
        if layer.__class__.__name__ == 'Transformer2DModel':
            ...
            from leffa.diffusion_model.transformer_gen import BasicTransformerBlock
...
def init_pipeline(pipeline):
    ...
    if 'transformer' in vars(pipeline).keys():
        ...
        if pipeline.unet.__class__.__name__ == 'UNet2DConditionModel':
            ...
            pipeline.unet = register_attention_hook(pipeline.unet, hook_function, 'attn1')
